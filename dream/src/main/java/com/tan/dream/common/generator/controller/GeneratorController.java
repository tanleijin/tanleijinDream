package com.tan.dream.common.generator.controller;
...
public class GeneratorController {
	...
	@ResponseBody
	@PostMapping("/update")
	ResultVO update(@RequestParam Map<String, Object> map) {
		try {
			...
			throw new DreamException(DreamExceptionEnum.SAVE_CONFIG_ERROR);
		}
		return ResultVO.ok();
	}
}
